...
export default class AgendaDetail extends Component {
    ...
    componentWillMount() {
        let productions = realm
            .objects('Production')
            .filtered('place_id = ' + this.state.params.id);
            ...
            return (
                <Card
                    ...
                    title={`Informações ${
                        realm
                            .objects('Crop')
                            .filtered('id = ' + production.crop_id)[0].name
                    }`}
                >
                    <View>
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>Safra: </Text>{' '}
                            {
                                realm
                                    .objects('Crop')
                                    .filtered('id = ' + production.crop_id)[0]
                                    .name
                            }
                        </Text>
                        <Text style={styles.infosText}>
                        ...
                        <Text style={styles.infosText}>
                            ...
                            {moment(production.planting_date).format(
                                'DD/MM/YYYY'
                            )}
                        </Text>
                        <Text style={styles.infosText}>
                            ...
                            {moment(production.harvest_date).format(
                                'DD/MM/YYYY'
                            )}
                        </Text>
                        <Text style={styles.infosText}>
                        ...
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>Argila: </Text>{' '}
                            {production.argil}
                        </Text>
                        <Text style={styles.infosText}>
                        ...
                        <Text style={styles.infosText}>
                            ...
                            {production.depth_gathering}
                        </Text>
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>
                                Dessecada:{' '}
                            </Text>{' '}
                            {production.desiccation ? 'Sim' : 'Não'}
                        </Text>
                    </View>
                </Card>
            );
                ...
                <Card title="DESCRIÇÃO FAZENDA">
                    <View style={styles.infos}>
                        ...
                        <Text style={styles.infosText}>
                            ...
                            {this.state.params.inscription}
                        </Text>
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>
                                Contato:{' '}
                            </Text>{' '}
                            {this.state.params.client_contact}
                        </Text>
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>
                                Telefone:{' '}
                            </Text>{' '}
                            {this.state.params.client_phone}
                        </Text>
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>
                                Endereço:{' '}
                        ...
                        <Text style={styles.infosText}>
                            ...
                            {this.state.params.itinerary}
                        </Text>
                        <Text style={styles.infosText}>
                            <Text style={{ fontWeight: 'bold' }}>
                                Cidade/UF:{' '}
                            </Text>{' '}
                            {this.state.params.city} - {this.state.params.state}
                        </Text>
                    </View>
